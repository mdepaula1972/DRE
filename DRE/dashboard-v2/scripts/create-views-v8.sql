-- SQL v8 - Corrige cálculo de status (LIQUIDADO quando remaining_installments = 0)
...
WITH json_contracts AS (
    SELECT 
        ...
        -- CORREÇÃO: status dinâmico baseado em remaining_installments
        CASE 
            WHEN GREATEST(0, 
                (value->>'installments')::int - 
                GREATEST(0, 
